...
| `v2.5.0-rc.10` | cut | the phone-launch candidate re-cut with the audit fix, to reach what rc.9 stopped one job short of: signing a payload under its own purpose and key id through the release signing authority, and a draft whose asset set carries three payloads with their envelopes and checksums beside the bundles |
