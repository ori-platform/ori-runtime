...
class ProofOperation:
    ...
    async def _consent(
        ...
        terminal.write(
            ...
            f"follows it\n"
            f"    on loss of coil power this zone's circuit goes "
            f"{zone.mapping['de_energised_terminal_state']}\n"
            f"    a process killed outright runs no cleanup and may leave this "
            f"output commanded; no software-guaranteed process-loss state "
            f"exists\n"
            "\n"
